...
function per1(){
    ...
    labels.forEach((label) => label.style.border = '1px solid yellow');
...
function per2(){
    ...
    let labels = document.querySelectorAll('label')
    labels.forEach((label) => label.style.border = '1px solid purple');
...
function per3(){
    ...
    let labels = document.querySelectorAll('label')
    labels.forEach((label) => label.style.border = '1px solid #E515A7');
